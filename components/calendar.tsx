...
export default function BookCalendar({ camp }) {
	...
	return (
		<div className='flex flex-col p-2 ml-auto space-y-2 bg-gray-100 border border-gray-700 rounded-md shadow-md w-fit'>
			<style>{css}</style>
			...
			<div className=''>
				<DayPicker
					...
					styles={{
						caption: { color: 'teal' },
						// selected: { color: 'white', backgroundColor: 'teal' },
					}}
					modifiersStyles={{ disabled: { color: 'gray', fontSize: '90%' } }}
